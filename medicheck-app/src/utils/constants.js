...
export const CHENNAI_DOCTORS = [
  // General Physician
  {
    ...
    phone: '+91 44 2829 3333', available: true, icon: '👨‍⚕️',
  ...
  },
  {
    ...
    phone: '+91 44 4289 2222', available: true, icon: '👩‍⚕️',
  ...
  },
  {
    ...
    phone: '+91 44 4200 2288', available: true, icon: '👨‍⚕️',
  ...
  // Cardiologist
  {
    ...
    phone: '+91 44 2656 7777', available: true, icon: '👨‍⚕️',
  ...
  },
  {
    ...
    phone: '+91 44 4592 8500', available: true, icon: '👩‍⚕️',
  ...
  },
  {
    ...
    phone: '+91 44 4000 6000', available: false, icon: '👨‍⚕️',
  ...
  // Dermatologist
  {
    ...
    phone: '+91 44 2431 5678', available: true, icon: '👩‍⚕️',
  ...
  },
  {
    ...
    phone: '+91 44 2823 0707', available: true, icon: '👨‍⚕️',
  ...
  // ENT
  {
    ...
    phone: '+91 44 2365 4321', available: true, icon: '👨‍⚕️',
  ...
  },
  {
    ...
    phone: '+91 44 2641 5678', available: true, icon: '👩‍⚕️',
  ...
  // Pediatrician
  {
    ...
    phone: '+91 44 4343 4343', available: true, icon: '👩‍⚕️',
  ...
  },
  {
    ...
    phone: '+91 44 2827 6480', available: true, icon: '👨‍⚕️',
  ...
  // Gynecologist
  {
    ...
    phone: '+91 44 4443 3000', available: true, icon: '👩‍⚕️',
  ...
  // Ophthalmologist
  {
    ...
    phone: '+91 44 2827 1616', available: true, icon: '👨‍⚕️',
  ...
  },
  {
    ...
    phone: '+91 44 2362 1212', available: true, icon: '👩‍⚕️',
  ...
  // Dentist
  {
    ...
    phone: '+91 44 4747 8888', available: true, icon: '👨‍⚕️',
  ...
  },
  {
    ...
    phone: '+91 44 4500 0000', available: true, icon: '👩‍⚕️',
  ...
  // Gastroenterologist
  {
    ...
    phone: '+91 44 4477 7000', available: true, icon: '👨‍⚕️',
  ...
  },
  {
    ...
    phone: '+91 44 4000 6000', available: true, icon: '👩‍⚕️',
  ...
  // Psychiatrist
  {
    ...
    phone: '+91 44 2641 0005', available: true, icon: '👨‍⚕️',
